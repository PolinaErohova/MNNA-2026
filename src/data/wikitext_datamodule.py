...
class PackedBatchesDataset(Dataset):
    """
    Простой Dataset поверх готовых packed batches.
...
class WikiTextDataModule(pl.LightningDataModule):
    """
    DataModule для wikitext packed batches из ЛР1.

    Пути:
      - npz_path: путь к wikitext_packed_batches.npz
      - batch_size: размер батча
      - val_split: доля валидации (по умолчанию 0.05)
    """
    ...
    def setup(self, stage=None):
        ...
        # Перемешиваем индексы (фиксированный seed)
